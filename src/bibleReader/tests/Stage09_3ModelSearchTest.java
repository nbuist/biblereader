...
public class Stage09_3ModelSearchTest {
	...
	public void testGetReferenceContainingWithOneResult() {
		ArrayList<Reference> results = model.getReferencesContaining("Christians");
	...
	public void testGetReferencesContainingWithManyResults() {
		...
		// Biblegateway.com gets 348 results. If you don't pass this test, talk to me
		// ASAP!
	...
	public void testCombinedSearch1() {
		...
		kjvList.add(new Verse(new Reference(BookOfBible.Genesis, 49, 24),
				"But his bow abode in strength, and the arms of his hands were made strong by the hands of the mighty God of Jacob; (from thence is the shepherd, the stone of Israel:)"));
		kjvList.add(new Verse(new Reference(BookOfBible.Joshua, 22, 22),
		...
		kjvList.add(new Verse(new Reference(BookOfBible.Psalms, 50, 1),
				"The mighty God, even the LORD, hath spoken, and called the earth from the rising of the sun unto the going down thereof."));
		kjvList.add(new Verse(new Reference(BookOfBible.Psalms, 89, 8),
				"O LORD God of hosts, who is a strong LORD like unto thee? or to thy faithfulness round about thee?"));
		kjvList.add(new Verse(new Reference(BookOfBible.Psalms, 103, 20),
		...
		kjvList.add(new Verse(new Reference(BookOfBible.Isaiah, 1, 24),
				"Therefore saith the LORD, the LORD of hosts, the mighty One of Israel, Ah, I will ease me of mine adversaries, and avenge me of mine enemies:"));
		kjvList.add(new Verse(new Reference(BookOfBible.Isaiah, 10, 34),
				"And he shall cut down the thickets of the forest with iron, and Lebanon shall fall by a mighty one."));
		kjvList.add(new Verse(new Reference(BookOfBible.Isaiah, 13, 3),
				"I have commanded my sanctified ones, I have also called my mighty ones for mine anger, even them that rejoice in my highness."));
		kjvList.add(new Verse(new Reference(BookOfBible.Isaiah, 30, 29),
				"Ye shall have a song, as in the night when a holy solemnity is kept; and gladness of heart, as when one goeth with a pipe to come into the mountain of the LORD, to the mighty One of Israel."));
		kjvList.add(new Verse(new Reference(BookOfBible.Isaiah, 40, 10),
				"Behold, the Lord GOD will come with strong hand, and his arm shall rule for him: behold, his reward is with him, and his work before him."));
		kjvList.add(new Verse(new Reference(BookOfBible.Isaiah, 49, 26),
				"And I will feed them that oppress thee with their own flesh; and they shall be drunken with their own blood, as with sweet wine: and all flesh shall know that I the LORD am thy Saviour and thy Redeemer, the mighty One of Jacob."));
		kjvList.add(new Verse(new Reference(BookOfBible.Isaiah, 60, 16),
				"Thou shalt also suck the milk of the Gentiles, and shalt suck the breast of kings: and thou shalt know that I the LORD am thy Saviour and thy Redeemer, the mighty One of Jacob."));
		kjvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 20, 11),
				"But the LORD is with me as a mighty terrible one: therefore my persecutors shall stumble, and they shall not prevail: they shall be greatly ashamed; for they shall not prosper: their everlasting confusion shall never be forgotten."));
		kjvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 46, 5),
				"Wherefore have I seen them dismayed and turned away back? and their mighty ones are beaten down, and are fled apace, and look not back: for fear was round about, saith the LORD."));
		kjvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 46, 15),
				"Why are thy valiant men swept away? they stood not, because the LORD did drive them."));
		kjvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 31, 11),
				"I have therefore delivered him into the hand of the mighty one of the heathen; he shall surely deal with him: I have driven him out for his wickedness."));
		kjvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 31, 14),
				"To the end that none of all the trees by the waters exalt themselves for their height, neither shoot up their top among the thick boughs, neither their trees stand up in their height, all that drink water: for they are all delivered unto death, to the nether parts of the earth, in the midst of the children of men, with them that go down to the pit."));
		kjvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 32, 12),
				"By the swords of the mighty will I cause thy multitude to fall, the terrible of the nations, all of them: and they shall spoil the pomp of Egypt, and all the multitude thereof shall be destroyed."));
		kjvList.add(new Verse(new Reference(BookOfBible.Daniel, 8, 24),
				"And his power shall be mighty, but not by his own power: and he shall destroy wonderfully, and shall prosper, and practise, and shall destroy the mighty and the holy people."));
		kjvList.add(new Verse(new Reference(BookOfBible.Joel, 3, 11),
				"Assemble yourselves, and come, all ye heathen, and gather yourselves together round about: thither cause thy mighty ones to come down, O LORD."));
		kjvList.add(new Verse(new Reference(BookOfBible.Zephaniah, 3, 17),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Genesis, 10, 8),
				"And Cush begat Nimrod: he began to be a mighty one in the earth."));
		asvList.add(new Verse(new Reference(BookOfBible.Genesis, 49, 24),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Joshua, 22, 22),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Psalms, 50, 1),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Psalms, 103, 20),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Isaiah, 1, 24),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Isaiah, 30, 29),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Isaiah, 40, 10),
				"Behold, the Lord Jehovah will come as a mighty one, and his arm will rule for him: Behold, his reward is with him, and his recompense before him."));
		asvList.add(new Verse(new Reference(BookOfBible.Isaiah, 49, 26),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Isaiah, 60, 16),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 20, 11),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 46, 5),
				"Wherefore have I seen it? they are dismayed and are turned backward; and their mighty ones are beaten down, and are fled apace, and look not back: terror is on every side, saith Jehovah."));
		asvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 46, 15),
				"Why are thy strong ones swept away? they stood not, because Jehovah did drive them."));
		asvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 31, 11),
				"I will even deliver him into the hand of the mighty one of the nations; he shall surely deal with him; I have driven him out for his wickedness."));
		asvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 31, 14),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 32, 12),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Daniel, 8, 24),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Joel, 3, 11),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Zephaniah, 3, 17),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Genesis, 49, 24),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Joshua, 22, 22),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Chronicles1, 1, 10),
				"Cush fathered Nimrod. He was the first on earth to be a mighty man."));
		esvList.add(new Verse(new Reference(BookOfBible.Psalms, 45, 3),
				"<sup>z</sup>Gird your <sup>a</sup>sword on your thigh, O <sup>b</sup>mighty one, in <sup>c</sup>your splendor and majesty!"));
		esvList.add(new Verse(new Reference(BookOfBible.Psalms, 50, 1),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Psalms, 103, 20),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Isaiah, 1, 24),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Isaiah, 40, 10),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Isaiah, 49, 26),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Isaiah, 60, 16),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 20, 11),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Jeremiah, 46, 5),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 31, 11),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 31, 14),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 32, 12),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Daniel, 8, 24),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Joel, 3, 11),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Zephaniah, 3, 17),
		...
		ArrayList<Reference> actualRefs = model.getReferencesContaining("mighty one");
	...
	public void testCombinedSearch2() {
		...
		kjvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 19),
				"Now thou art commanded, this do ye; take you wagons out of the land of Egypt for your little ones, and for your wives, and bring your father, and come."));
		kjvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 21),
				"And the children of Israel did so: and Joseph gave them wagons, according to the commandment of Pharaoh, and gave them provision for the way."));
		kjvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 27),
				"And they told him all the words of Joseph, which he had said unto them: and when he saw the wagons which Joseph had sent to carry him, the spirit of Jacob their father revived:"));
		kjvList.add(new Verse(new Reference(BookOfBible.Genesis, 46, 5),
				"And Jacob rose up from Beersheba: and the sons of Israel carried Jacob their father, and their little ones, and their wives, in the wagons which Pharaoh had sent to carry him."));
		kjvList.add(new Verse(new Reference(BookOfBible.Numbers, 7, 3),
		...
		kjvList.add(new Verse(new Reference(BookOfBible.Numbers, 7, 8),
				"And four wagons and eight oxen he gave unto the sons of Merari, according unto their service, under the hand of Ithamar the son of Aaron the priest."));
		kjvList.add(new Verse(new Reference(BookOfBible.Samuel1, 17, 20),
				"And David rose up early in the morning, and left the sheep with a keeper, and took, and went, as Jesse had commanded him; and he came to the trench, as the host was going forth to the fight, and shouted for the battle."));
		kjvList.add(new Verse(new Reference(BookOfBible.Samuel1, 26, 5),
				"And David arose, and came to the place where Saul had pitched: and David beheld the place where Saul lay, and Abner the son of Ner, the captain of his host: and Saul lay in the trench, and the people pitched round about him."));
		kjvList.add(new Verse(new Reference(BookOfBible.Samuel1, 26, 7),
				"So David and Abishai came to the people by night: and, behold, Saul lay sleeping within the trench, and his spear stuck in the ground at his bolster: but Abner and the people lay round about him."));
		kjvList.add(new Verse(new Reference(BookOfBible.Psalms, 65, 11),
				"Thou crownest the year with thy goodness; and thy paths drop fatness."));
		kjvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 23, 24),
				"And they shall come against thee with chariots, wagons, and wheels, and with an assembly of people, which shall set against thee buckler and shield and helmet round about: and I will set judgment before them, and they shall judge thee according to their judgments."));
		kjvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 26, 10),
				"By reason of the abundance of his horses their dust shall cover thee: thy walls shall shake at the noise of the horsemen, and of the wheels, and of the chariots, when he shall enter into thy gates, as men enter into a city wherein is made a breach."));

		VerseList asvList = new VerseList("ASV", "wagon");
		asvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 19),
				"Now thou art commanded, this do ye: take you wagons out of the land of Egypt for your little ones, and for your wives, and bring your father, and come."));
		asvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 21),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 27),
				"And they told him all the words of Joseph, which he had said unto them: and when he saw the wagons which Joseph had sent to carry him, the spirit of Jacob their father revived:"));
		asvList.add(new Verse(new Reference(BookOfBible.Genesis, 46, 5),
				"And Jacob rose up from Beer-sheba: and the sons of Israel carried Jacob their father, and their little ones, and their wives, in the wagons which Pharaoh had sent to carry him."));
		asvList.add(new Verse(new Reference(BookOfBible.Numbers, 7, 3),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Numbers, 7, 7),
				"Two wagons and four oxen he gave unto the sons of Gershon, according to their service:"));
		asvList.add(new Verse(new Reference(BookOfBible.Numbers, 7, 8),
				"and four wagons and eight oxen he gave unto the sons of Merari, according unto their service, under the hand of Ithamar the son of Aaron the priest."));
		asvList.add(new Verse(new Reference(BookOfBible.Samuel1, 17, 20),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Samuel1, 26, 5),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Samuel1, 26, 7),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Psalms, 65, 11),
				"Thou crownest the year with thy goodness; And thy paths drop fatness."));
		asvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 23, 24),
		...
		asvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 26, 10),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 19),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 21),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Genesis, 45, 27),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Genesis, 46, 5),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Numbers, 7, 3),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Numbers, 7, 8),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Samuel1, 17, 20),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Samuel1, 26, 5),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Samuel1, 26, 7),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 23, 24),
		...
		esvList.add(new Verse(new Reference(BookOfBible.Ezekiel, 26, 10),
		...
		ArrayList<Reference> actualRefs = model.getReferencesContaining("wagon");
