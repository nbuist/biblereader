...
public interface Bible {
	 ...
	 */
	public abstract ArrayList<Reference> getReferencesContaining(String phrase);
	 ...
	 */
	public abstract VerseList getVerses(ArrayList<Reference> references);
	...
	// -------------------------------------------------------------------------------------------------
	// Passage getters that return ArrayList<Reference>s.
	/**
	 * @param firstVerse
	 ...
	 */
	public abstract ArrayList<Reference> getReferencesInclusive(Reference firstVerse, Reference lastVerse);
	 ...
	 */
	public abstract ArrayList<Reference> getReferencesExclusive(Reference firstVerse, Reference lastVerse);
	 ...
	 */
	public abstract ArrayList<Reference> getReferencesForBook(BookOfBible book);
	 ...
	 */
	public abstract ArrayList<Reference> getReferencesForChapter(BookOfBible book, int chapter);
	 ...
	 *         invalid in this Bible.
	 */
	public abstract ArrayList<Reference> getReferencesForChapters(BookOfBible book, int chapter1, int chapter2);
	 ...
	 *         Bible.
	 */
	public abstract ArrayList<Reference> getReferencesForPassage(BookOfBible book, int chapter, int verse1, int verse2);
	 ...
	 *         Bible.
	 */
	public abstract ArrayList<Reference> getReferencesForPassage(BookOfBible book, int chapter1, int verse1, int chapter2,
			int verse2);
